...
CREATE TABLE IF NOT EXISTS npc (
    ...
    mp INTEGER NOT NULL DEFAULT 50 CHECK (mp >= 0),
    str INTEGER CHECK (str BETWEEN 0 AND 99),
    dex INTEGER CHECK (dex BETWEEN 0 AND 99),
    int INTEGER CHECK (int BETWEEN 0 AND 99),
    lux INTEGER CHECK (lux BETWEEN 0 AND 99),
